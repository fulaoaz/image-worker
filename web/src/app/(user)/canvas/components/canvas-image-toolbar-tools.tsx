...
import { Brush, Camera, Code2, Copy, FileText, Grid2x2, Lock, LockOpen, Maximize2, Scissors, Sparkles, Upload, WandSparkles, ZoomIn } from "lucide-react";
...
export const imageToolDefinitions: ImageToolDefinition[] = [
    ...
    },
    {
        ...
        panelLabel: "编辑 SVG",
        label: "编辑 SVG",
        title: "打开在线 SVG 源码编辑器",
        icon: () => <Code2 className="size-4" />,
        active: (node) => Boolean(node.metadata?.editableSvg || node.metadata?.mimeType?.includes("svg") || node.metadata?.content?.startsWith("data:image/svg+xml")),
