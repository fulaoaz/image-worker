export default {
    ...
    canvas: {
        ...
        editors: {
            ...
            svgTitle: "Visual object editing", svgDescription: "Click a shape or text to select it, drag to move; edit text, fill, stroke and opacity on the right. Source editing is an advanced option.", svgCanvas: "Object canvas", svgObjects: "{{count}} selectable objects", svgWaiting: "Waiting for valid SVG", svgSelected: "Selected: {{label}}", svgSelectHint: "Click an object on the left to start editing", svgDragHint: "Drag the selected object on the left to move it", svgText: "Text content", svgFill: "Fill", svgStroke: "Stroke", svgOpacity: "Opacity", svgOpacityPlaceholder: "0-1, leave empty for default", svgColorPlaceholder: "e.g. #2f80ff / none", svgSource: "Advanced: SVG source", svgSourcePlaceholder: "Paste or edit <svg>...</svg> here", svgSourceLoading: "Loading SVG...", svgSave: "Save to canvas", svgPreview: "SVG preview", svgReadFailed: "Failed to read SVG", svgUpdateFailed: "Failed to update SVG", svgTextUpdateFailed: "Failed to update text", svgDeleteFailed: "Failed to delete element", svgDragFailed: "Failed to drag", svgParseFailed: "Failed to parse SVG", svgMissingElement: "The selected SVG element no longer exists", svgNotEditable: "This node is not an editable SVG. Use \"To editable\" first.",
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Image Worker</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Image Worker, grouped by object store.",
            ...
            mainDatabase: "Image Worker data",
        ...
        channels: {
            ...
            serverTitle: "Server-managed providers",
            serverDescription: "Providers configured by an administrator. API keys stay on the server; refresh to use these models in the picker.",
            serverRefresh: "Refresh server providers",
            serverManaged: "Server-managed",
            serverReady: "Ready to use",
            serverLoading: "Loading server providers…",
            serverEmpty: "No server-managed providers are available.",
            serverLoaded: "Loaded {{count}} server-managed providers",
            serverLoadFailed: "Failed to load server-managed providers",
        },
        preferences: {
            interface: "Interface",
    ...
    admin: {
        eyebrow: "IMAGE WORKER ADMIN",
        title: "Server-side model providers",
        description: "Providers and API keys stay in the server data directory. Users receive the enabled models after refresh, never the API keys.",
        back: "Back to app",
        token: "Admin token",
        tokenDescription: "Used only for this read or save and never stored in the browser.",
        tokenPlaceholder: "Server environment variable ADMIN_TOKEN",
        load: "Load configuration",
        reload: "Reload",
        save: "Save to server",
        tokenRequired: "Enter the admin token first",
        loadFailed: "Failed to read server configuration",
        loaded: "Server configuration loaded",
        saveFailed: "Failed to save server configuration",
        saved: "Server configuration saved. Users can use it after refreshing.",
        defaultChannel: "Server provider",
        channelNumber: "Provider {{count}}",
        providers: "Model providers",
        providerDescription: "{{configured}} / {{total}} ready. Each provider's models are shown to users by capability.",
        add: "Add provider",
        ready: "Ready",
        draft: "Incomplete",
        empty: "There are no providers yet. Add one, then enter its endpoint and models in the drawer.",
    },
    agent: {
