...
<p align="center">
  ...
  <a href="https://github.com/fulaoaz/image-worker/tags"><img src="https://img.shields.io/github/v/tag/fulaoaz/image-worker?style=flat-square&label=version" alt="Version"></a>
...
Image Worker 是一款面向图片创作的开源工作台。它把画布编排、AI 图片生成、参考图编辑、对话助手、提示词库和素材沉淀放在同一个界面里，适合用来探索视觉方案并连续迭代图片结果。
