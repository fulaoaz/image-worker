...
```text
Install the Infinite Canvas Codex plugin from https://github.com/fulaoaz/image-worker.git.
...
```bash
mkdir -p ~/plugins
git clone https://github.com/fulaoaz/image-worker.git ~/plugins/infinite-canvas
