...
See [SECURITY.md](https://github.com/fulaoaz/image-worker/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.

Use GitHub private vulnerability reporting or a Security Advisory.
