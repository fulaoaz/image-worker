...
const messages = {
  en: {
    ...
    content: '# Changelog\n\nThe detailed changelog is currently maintained in Chinese. See the [source changelog](https://github.com/fulaoaz/image-worker/blob/main/CHANGELOG.md) for all releases.',
  },
  'zh-CN': {
    title: '更新日志',
